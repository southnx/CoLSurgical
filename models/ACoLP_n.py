...
class ACoLP(nn.Module):
    def __init__(
        ...
        ROOT_TRAIN: str = '/home/da/Desktop/TripletAction_ACoLP/small_keyframes_train/', 
        ROOT_VAL: str = '/home/da/Desktop/TripletAction_ACoLP/small_keyframes_val/'
    ):
        super().__init__()
    ...
    def forward(self, video_seg: list, frame_names: list):
        ...
        for k in range(num_clips):
            ...
            for i in range(num_frames):
                ...
                frame_fea = self.net(video_seg[k][i].unsqueeze(0))   # on cpu !
